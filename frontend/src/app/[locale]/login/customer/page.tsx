...
import { Eye, EyeOff, Mail, Phone, Lock, ArrowRight, Loader2, User } from 'lucide-react'
    ...
    try {
      ...
      if (response.success) {
        ...
        if (response.data.user.role !== 'customer') {
          alert('هذا الحساب ليس حساب عميل. يرجى استخدام دخول مقدمي الخدمة.')
          return
        }
    ...
    <div className="min-h-screen bg-gradient-to-br from-gold-50 to-gold-100 flex items-center justify-center pt-32 pb-12 px-4 sm:px-6 lg:px-8" dir={isRTL ? 'rtl' : 'ltr'}>
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          {/* Customer Icon */}
          <div className="mb-4">
            <div className="bg-gold-500 p-3 rounded-full inline-block">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full px-4 py-4 pr-12 border rounded-xl focus:ring-2 focus:ring-gold-500 focus:border-transparent text-lg ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full px-4 py-4 pr-12 pl-12 border rounded-xl focus:ring-2 focus:ring-gold-500 focus:border-transparent text-lg ${
