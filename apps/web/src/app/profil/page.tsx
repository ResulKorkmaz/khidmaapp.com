        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Profil bilgilerini düzenle ve müşterilerin seni daha iyi tanımasını sağla</p>
            </div>
          ...
          <div className="p-8">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">JPG, PNG formatında, maksimum 5MB</p>
                  </div>
                </div>
            ...
            {activeTab === "hizmetler" && (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Hizmetler Yakında!</h3>
                <p className="text-gray-600">Hizmet yönetimi özelliği yakında eklenecek.</p>
              </div>
            )}
            ...
            {activeTab === "portfoy" && (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Portföy Yakında!</h3>
                <p className="text-gray-600">İş örnekleri ve portföy yönetimi yakında eklenecek.</p>
              </div>
            )}
            ...
            {activeTab === "ayarlar" && (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Ayarlar Yakında!</h3>
                <p className="text-gray-600">Hesap ayarları ve güvenlik seçenekleri yakında eklenecek.</p>
              </div>
            )}
          </div>
        </div>
          ...
          >
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Gelen teklifleri görüntüle</p>
              </div>
            </div>
          </Link>
