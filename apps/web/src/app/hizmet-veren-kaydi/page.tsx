...
export default function ServiceProviderRegistrationPage() {
  ...
  const filteredServices = HIZMETLER.filter((service) => {
    ...
    if (searchWords.length === 1) {
      ...
      for (let word of words) {
        if (
          ...
          word.startsWith(searchWords[searchIndex])
        ) {
          searchIndex++;
        }
      }
    ...
    const aWordsMatch = aLower
      .split(" ")
      .some((word) => word.startsWith(searchLower));
    const bWordsMatch = bLower
      .split(" ")
      .some((word) => word.startsWith(searchLower));
  ...
  const handleNextStep = async () => {
    if (currentStep === 1 && selectedServices.length > 0) {
      ...
      const email =
        accountType === "individual" ? formData.email : formData.companyEmail;
      const phone =
        accountType === "individual" ? formData.phone : formData.companyPhone;
  ...
  const checkExistingUser = async (email: string, phone: string) => {
    ...
    const existingByEmail = mockUsers.find(
            ...
            <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-start">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <p>
                    Eğer bu hesap size ait değilse, farklı e-posta adresi ve
                    telefon numarası ile kayıt olabilirsiniz.
                  </p>
                </div>
              </div>
            </div>
              ...
              <>
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600 text-sm">
                    {currentStep === 1 &&
                      "Sunduğun hizmetleri seç (maksimum 5 hizmet) ve müşterilerin seni kolayca bulsun"}
                    {currentStep === 2 &&
                      "Bireysel mi yoksa şirket hesabı mı açmak istiyorsun?"}
                    {currentStep === 3 &&
                      (accountType === "individual"
                        ? "Profilini oluşturmak için kişisel bilgilerini gir"
                        : "Şirket profilini oluşturmak için şirket bilgilerini gir")}
                    {currentStep === 4 &&
                      "Uzmanlık alanlarını ve deneyimlerini paylaş"}
                            ...
                            <div className="flex items-start">
                              ...
                              <div className="text-sm text-amber-800">
                                <p className="font-medium">
                                  Maksimum hizmet sayısına ulaştın!
                                </p>
                                <p>
                                  En fazla 5 hizmet seçebilirsin. Değişiklik
                                  yapmak için mevcut hizmetlerden birini kaldır.
                                </p>
                              </div>
                            </div>
                          </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      >
                        ...
                        >
                          Kendi adına hizmet vermek istiyorsan bu seçeneği seç.
                          Hızlı kayıt ve kolay başlangıç.
                        </p>
                      ...
                      >
                        ...
                        >
                          Şirket adına hizmet vermek istiyorsan bu seçeneği seç.
                          Profesyonel görünüm ve ekip yönetimi.
                        </p>
                        <div className="mt-4 space-y-2">
                          <div className="flex items-center text-sm text-gray-600">
                            <svg
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="text-sm">
                          ...
                          <p className="text-gray-600 mt-1">
                            ...
                            &apos;nı okudum, anladım ve kabul ediyorum. Kişisel
                            verilerimin belirtilen amaçlar doğrultusunda
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      <div className="flex items-start">
                        ...
                        <div className="text-sm text-blue-800">
                          ...
                          <p>
                            Detaylı ve samimi bir tanıtım yazarak müşterilerin
                            güvenini kazanabilirsin. Önceki işlerinden örnekler
                            verebilir, çalışma prensiplerini paylaşabilirsin.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                      <div className="flex items-start">
                        ...
                        <div className="text-sm text-green-800">
                          ...
                          <p>
                            Güvenli bir şifre oluştur ve OnlineUsta ailesine
                            katıl. Kayıt olduktan sonra hemen müşteri
                            tekliflerini almaya başlayabilirsin.
                          </p>
                        </div>
                      </div>
                    </div>
