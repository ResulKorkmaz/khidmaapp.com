          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div className="group">
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-semibold text-gray-900 text-center mb-2">Elektrik Tamiri</h3>
            ...
            <div className="group">
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-semibold text-gray-900 text-center mb-2">Tesisatçı</h3>
                  <div className="flex items-center justify-center text-sm text-gray-500 mb-4">
                    <svg className="w-4 h-4 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                    </svg>
            ...
            <div className="group">
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-semibold text-gray-900 text-center mb-2">Ev Temizliği</h3>
                  <div className="flex items-center justify-center text-sm text-gray-500 mb-4">
                    <svg className="w-4 h-4 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                    </svg>
            ...
            <div className="group">
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-semibold text-gray-900 text-center mb-2">Boyacı</h3>
                  <div className="flex items-center justify-center text-sm text-gray-500 mb-4">
                    <svg className="w-4 h-4 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                    </svg>
            ...
            <div className="group">
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-semibold text-gray-900 text-center mb-2">Klima Tamiri</h3>
                  <div className="flex items-center justify-center text-sm text-gray-500 mb-4">
                    <svg className="w-4 h-4 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                    </svg>
            ...
            <div className="group">
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-semibold text-gray-900 text-center mb-2">Mobilyacı</h3>
                  <div className="flex items-center justify-center text-sm text-gray-500 mb-4">
                    <svg className="w-4 h-4 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                    </svg>
            ...
            <div className="group">
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-semibold text-gray-900 text-center mb-2">Oto Tamiri</h3>
                  <div className="flex items-center justify-center text-sm text-gray-500 mb-4">
                    <svg className="w-4 h-4 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                    </svg>
            ...
            <div className="group">
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-semibold text-gray-900 text-center mb-2">Bilgisayar Tamiri</h3>
                  <div className="flex items-center justify-center text-sm text-gray-500 mb-4">
                    <svg className="w-4 h-4 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                    </svg>
            ...
            <div className="group">
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-semibold text-gray-900 text-center mb-2">Bahçıvan</h3>
                  <div className="flex items-center justify-center text-sm text-gray-500 mb-4">
                    <svg className="w-4 h-4 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                    </svg>
            ...
            <div className="group">
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-semibold text-gray-900 text-center mb-2">Nakliyat</h3>
                  <div className="flex items-center justify-center text-sm text-gray-500 mb-4">
                    <svg className="w-4 h-4 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                    </svg>
            ...
            <div className="group">
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-semibold text-gray-900 text-center mb-2">Marangoz</h3>
                  <div className="flex items-center justify-center text-sm text-gray-500 mb-4">
                    <svg className="w-4 h-4 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                    </svg>
            ...
            <div className="group">
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-semibold text-gray-900 text-center mb-2">Telefon Tamiri</h3>
                  <div className="flex items-center justify-center text-sm text-gray-500 mb-4">
                    <svg className="w-4 h-4 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                    </svg>
          ...
          <div className="relative max-w-6xl mx-auto">
            ...
            <div className="hidden md:block absolute top-24 left-1/2 transform -translate-x-1/2 w-full max-w-4xl">
              <div className="relative h-1">
                ...
                <div className="absolute top-1/2 transform -translate-y-1/2 w-4 h-4 bg-purple-500 rounded-full border-2 border-white shadow-md" style={{left: '100%', transform: 'translateX(-100%) translateY(-50%)'}}></div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
              ...
              <div className="flex flex-col items-center group">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105 border border-gray-100 h-full flex flex-col">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">Talebinizi Oluşturun</h3>
                  <p className="text-gray-600 leading-relaxed text-center flex-grow">
                    İhtiyacınızı detayları ile birlikte tanımlayın. Hangi hizmeti istediğinizi, ne zaman yapılmasını istediğinizi belirtin.
                  </p>
              ...
              <div className="flex flex-col items-center group">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105 border border-gray-100 h-full flex flex-col">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">Teklifleri Alın</h3>
                  <p className="text-gray-600 leading-relaxed text-center flex-grow">
                    Alanında uzman ustalar size özel teklifler gönderir. Fiyat, süre ve hizmet detaylarını karşılaştırın.
                  </p>
                  <div className="mt-6 flex justify-center">
              ...
              <div className="flex flex-col items-center group">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105 border border-gray-100 h-full flex flex-col">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">Karşılaştır ve Seç</h3>
                  <p className="text-gray-600 leading-relaxed text-center flex-grow">
                    Müşteri yorumlarını incele, pazarlık yap. En uygun teklifi seçin.
                  </p>
                  <div className="mt-6 flex justify-center">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="text-center lg:text-left">
                <div className="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 mb-8">
                  ...
                  <span className="font-semibold text-lg">Profesyonel Usta Ol</span>
                </div>
                ...
                <p className="text-xl lg:text-2xl mb-8 text-blue-100 leading-relaxed">
                  Müşterilerimize kaliteli hizmet sunun ve güvenilir usta ağımızın bir parçası olun.
                </p>
              ...
              <div className="relative">
                ...
                <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20">
                  <div className="text-center mb-8">
                    <h3 className="text-2xl font-bold mb-2">Neden OnlineUsta?</h3>
                    <p className="text-blue-200">Profesyonel hizmet platformu</p>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center bg-white/10 rounded-xl p-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-blue-200 text-sm">Doğrulanmış ve güvenilir müşteri portföyü</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center bg-white/10 rounded-xl p-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-blue-200 text-sm">Rekabetçi ve şeffaf ücret sistemi</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center bg-white/10 rounded-xl p-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-blue-200 text-sm">Her zaman yanınızda olan teknik destek</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-8 pt-6 border-t border-white/20">
                    <div className="grid grid-cols-3 gap-4 text-center">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-blue-200">Tamamlanan İş</div>
                      </div>
                      <div>
                        <div className="text-2xl font-bold text-purple-300">4.8⭐</div>
                        <div className="text-sm text-blue-200">Müşteri Puanı</div>
                      </div>
            </div>
          </div>
        </div>
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Hizmet Bölgelerimiz
                ...
                Türkiye'nin her yerinde güvenilir ustalar! 32 büyük şehirde binlerce profesyonel usta ile hizmetinizdeyiz. 
                <span className="font-semibold text-green-600"> Ücretsiz teklif alın, en uygun ustayı seçin.</span>
            </p>
          </div>
          
          <div className="grid grid-cols-4 md:grid-cols-8 gap-4">
            {[
              { name: "İstanbul", population: "15.5M", region: "Marmara", icon: "🏙️" },
              { name: "Ankara", population: "5.7M", region: "İç Anadolu", icon: "🏛️" },
              { name: "İzmir", population: "4.4M", region: "Ege", icon: "🌊" },
              { name: "Bursa", population: "3.1M", region: "Marmara", icon: "🏔️" },
              { name: "Antalya", population: "2.6M", region: "Akdeniz", icon: "🏖️" },
              { name: "Adana", population: "2.3M", region: "Akdeniz", icon: "🌾" },
              { name: "Konya", population: "2.2M", region: "İç Anadolu", icon: "🕌" },
              { name: "Gaziantep", population: "2.1M", region: "Güneydoğu", icon: "🥙" },
              { name: "Şanlıurfa", population: "2.1M", region: "Güneydoğu", icon: "🏺" },
              { name: "Kocaeli", population: "2.0M", region: "Marmara", icon: "🏭" },
              { name: "Mersin", population: "1.9M", region: "Akdeniz", icon: "🚢" },
              { name: "Diyarbakır", population: "1.8M", region: "Güneydoğu", icon: "🏰" },
              { name: "Hatay", population: "1.7M", region: "Akdeniz", icon: "🌿" },
              { name: "Manisa", population: "1.4M", region: "Ege", icon: "🍇" },
              { name: "Kayseri", population: "1.4M", region: "İç Anadolu", icon: "⛰️" },
              { name: "Samsun", population: "1.4M", region: "Karadeniz", icon: "🌊" },
              { name: "Balıkesir", population: "1.2M", region: "Marmara", icon: "🐟" },
              { name: "K.Maraş", population: "1.2M", region: "Akdeniz", icon: "🍯" },
              { name: "Van", population: "1.1M", region: "Doğu Anadolu", icon: "🏔️" },
              { name: "Aydın", population: "1.1M", region: "Ege", icon: "🫒" },
              { name: "Batman", population: "0.6M", region: "Güneydoğu", icon: "🛢️" },
              { name: "Denizli", population: "1.0M", region: "Ege", icon: "♨️" },
              { name: "Tekirdağ", population: "1.0M", region: "Marmara", icon: "🌻" },
              { name: "Muğla", population: "1.0M", region: "Ege", icon: "🏖️" },
              { name: "Eskişehir", population: "0.9M", region: "İç Anadolu", icon: "🎓" },
              { name: "Trabzon", population: "0.8M", region: "Karadeniz", icon: "🌲" },
              { name: "Malatya", population: "0.8M", region: "Doğu Anadolu", icon: "🍑" },
              { name: "Erzurum", population: "0.8M", region: "Doğu Anadolu", icon: "❄️" },
              { name: "Ordu", population: "0.8M", region: "Karadeniz", icon: "🌰" },
              { name: "Sakarya", population: "1.0M", region: "Marmara", icon: "🌊" },
              { name: "Elazığ", population: "0.6M", region: "Doğu Anadolu", icon: "🌉" },
              { name: "Zonguldak", population: "0.6M", region: "Karadeniz", icon: "⛏️" }
            ].map((city) => (
              <div 
                key={city.name}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
                ...
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  OnlineUsta, Türkiye'nin güvenilir usta bulma platformudur. 
                  Müşteriler ve profesyonel ustalar arasında köprü kurarak, 
                  kaliteli hizmet almanızı sağlıyoruz.
                </p>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700">32 şehirde binlerce doğrulanmış usta</span>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700">Ücretsiz teklif alma hizmeti</span>
          </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">Güvenilir Ustalar</h4>
                      <p className="text-gray-600 text-sm">Kimlik ve yetkinlik kontrolünden geçmiş profesyoneller</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Dakikalar içinde uygun ustalardan teklif alın</p>
                    </div>
            </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">Geniş Kapsama</h4>
                      <p className="text-gray-600 text-sm">Türkiye'nin 32 büyük şehrinde hizmet</p>
              </div>
            </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">Sürekli Destek</h4>
                      <p className="text-gray-600 text-sm">Her adımda yanınızda olan müşteri hizmetleri</p>
                    </div>
                  </div>
                </div>
              </div>
