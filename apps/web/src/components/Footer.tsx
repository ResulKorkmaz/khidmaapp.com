        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-4">
              Türkiye&apos;nin güvenilir usta bulma platformu. 32 şehirde
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <p className="text-gray-600 text-xs">📧 info@onlineusta.com.tr</p>
            </div>
          </div>
        </div>
      </div>
