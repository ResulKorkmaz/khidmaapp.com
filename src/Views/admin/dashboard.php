...
<div class="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 flex items-center gap-4">
    <div class="w-10 h-10 bg-amber-100 rounded-full flex items-center justify-center"><span class="text-amber-600 text-xl">⚠️</span></div>
    <div class="flex-1">
    ...
    <a href="/admin/lead-requests" class="px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white font-medium rounded-lg transition-colors">Taleplere Git →</a>
</div>
<?php endif; ?>
...
<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
    <div class="stat-card blue bg-white rounded-xl p-4 shadow-sm">
        <div class="flex items-center justify-between mb-2">
            <span class="text-xs font-medium text-gray-500 uppercase">Toplam</span>
        ...
        <p class="text-2xl font-bold text-gray-900"><?= number_format($stats['total_leads'] ?? 0) ?></p>
    ...
    <div class="stat-card green bg-white rounded-xl p-4 shadow-sm">
        <div class="flex items-center justify-between mb-2">
            <span class="text-xs font-medium text-gray-500 uppercase">Yeni</span>
        ...
        <p class="text-2xl font-bold text-gray-900"><?= number_format($stats['new_leads'] ?? 0) ?></p>
    ...
    <div class="stat-card purple bg-white rounded-xl p-4 shadow-sm">
        <div class="flex items-center justify-between mb-2">
            <span class="text-xs font-medium text-gray-500 uppercase">Doğrulanmış</span>
        ...
        <p class="text-2xl font-bold text-gray-900"><?= number_format($stats['verified_leads'] ?? 0) ?></p>
    ...
    <div class="stat-card cyan bg-white rounded-xl p-4 shadow-sm">
        <div class="flex items-center justify-between mb-2">
            <span class="text-xs font-medium text-gray-500 uppercase">Satılan</span>
        ...
        <p class="text-2xl font-bold text-gray-900"><?= number_format($stats['sold_leads'] ?? 0) ?></p>
    ...
    <div class="stat-card orange bg-white rounded-xl p-4 shadow-sm">
        <div class="flex items-center justify-between mb-2">
            <span class="text-xs font-medium text-gray-500 uppercase">Bugün</span>
        ...
        <p class="text-2xl font-bold text-gray-900"><?= number_format($stats['today_leads'] ?? 0) ?></p>
        <span class="text-xs text-gray-400">Son 24 saat</span>
    </div>
    
    <div class="stat-card red bg-white rounded-xl p-4 shadow-sm">
        <div class="flex items-center justify-between mb-2">
            <span class="text-xs font-medium text-gray-500 uppercase">Bu Hafta</span>
        ...
        <p class="text-2xl font-bold text-gray-900"><?= number_format($stats['week_leads'] ?? 0) ?></p>
    ...
    <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
        <div class="flex items-center gap-3 mb-3">
            ...
            <div>
                ...
                <p class="text-xl font-bold text-gray-900"><?= $stats['active_providers'] ?? 0 ?> <span class="text-sm font-normal text-gray-400">/ <?= $stats['total_providers'] ?? 0 ?></span></p>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
        <div class="flex items-center gap-3 mb-3">
            ...
            <div>
                ...
                <p class="text-xl font-bold text-gray-900"><?= $stats['pending_providers'] ?? 0 ?></p>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
        <div class="flex items-center gap-3 mb-3">
            ...
            <div>
                ...
                <p class="text-xl font-bold text-gray-900"><?= number_format($stats['total_revenue'] ?? 0, 0) ?> <span class="text-sm font-normal">SAR</span></p>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
        <div class="flex items-center gap-3 mb-3">
            <div class="w-10 h-10 bg-pink-100 rounded-xl flex items-center justify-center">
                <svg class="w-5 h-5 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
            </div>
            <div>
                <p class="text-sm text-gray-500">Satın Almalar</p>
                <p class="text-xl font-bold text-gray-900"><?= $stats['total_purchases'] ?? 0 ?></p>
            </div>
        </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="divide-y divide-gray-50">
            ...
            <?php else: ?>
            <?php 
            $statusColors = ['new'=>'bg-blue-100 text-blue-700','verified'=>'bg-purple-100 text-purple-700','sold'=>'bg-green-100 text-green-700','pending'=>'bg-orange-100 text-orange-700','invalid'=>'bg-red-100 text-red-700'];
            $statusLabels = ['new'=>'Yeni','verified'=>'Doğrulanmış','sold'=>'Satılan','pending'=>'Beklemede','invalid'=>'Geçersiz'];
            ?>
            ...
            <a href="/admin/leads/<?= $lead['id'] ?>" class="block px-5 py-3 hover:bg-gray-50 transition-colors">
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-right">
                        <span class="inline-block px-2 py-0.5 text-xs font-medium rounded-full <?= $statusColors[$status] ?? 'bg-gray-100 text-gray-700' ?>"><?= $statusLabels[$status] ?? $status ?></span>
