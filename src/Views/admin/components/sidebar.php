...
<div class="hidden lg:block flex-shrink-0 px-6 py-4 border-t border-gray-200 relative">
    ...
    <div id="profileDropdown" class="hidden absolute bottom-full left-0 right-0 mb-2 mx-4 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden z-50">
        <!-- Profil Ayarları - Herkes için -->
        <a href="/admin/profile" class="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 transition-colors">
            ...
            <span class="text-sm font-medium text-gray-700">Profil Ayarları</span>
        </a>
        <div class="border-t border-gray-100"></div>
        <?php if ($currentUserRole === 'super_admin' || $currentUserRole === 'admin'): ?>
