...
<!-- Complaint Modal -->
<div id="complaintModal" class="fixed inset-0 z-[9999] hidden items-center justify-center p-4 transition-opacity duration-300" style="background: rgba(0, 0, 0, 0.7); backdrop-filter: blur(4px);">
    <div class="relative w-full max-w-2xl max-h-[85vh] md:max-h-[90vh] overflow-y-auto bg-white rounded-2xl md:rounded-3xl shadow-2xl transform transition-all duration-300 scale-95 opacity-0 my-4" id="complaintModalContent">
        <!-- Modal Header -->
        <div class="sticky top-0 bg-gradient-to-r from-red-600 to-red-700 text-white p-4 md:p-6 rounded-t-2xl md:rounded-t-3xl flex items-center justify-between z-10">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 md:w-12 md:h-12 bg-white/20 rounded-lg md:rounded-xl flex items-center justify-center flex-shrink-0">
                    <svg class="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z"/>
                    </svg>
                </div>
                <div>
                    <h3 class="text-xl md:text-2xl font-bold">تقديم شكوى</h3>
                    <p class="text-red-100 text-xs md:text-sm">نحن هنا لمساعدتك وحل مشكلتك</p>
                </div>
            </div>
            <button onclick="closeComplaintModal()" class="w-9 h-9 md:w-10 md:h-10 bg-white/20 hover:bg-white/30 rounded-lg md:rounded-xl flex items-center justify-center transition-colors flex-shrink-0">
        ...
        <div class="p-4 md:p-6 lg:p-8">
            <!-- Info Box -->
            <div class="mb-4 md:mb-6 p-3 md:p-4 bg-blue-50 rounded-lg md:rounded-xl border border-blue-200">
            ...
            <!-- Complaint Form -->
            <form id="complaintForm" class="space-y-4 md:space-y-5">
                <!-- Name -->
                <div>
                    <label for="complaint_name" class="block text-xs md:text-sm font-semibold text-gray-900 mb-2">
                        الاسم الكامل *
                    </label>
                    <input type="text" 
                           id="complaint_name" 
                           name="name" 
                           required
                           class="w-full px-3 md:px-4 py-2.5 md:py-3 text-sm md:text-base border border-gray-300 rounded-lg md:rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all"
                           placeholder="أدخل اسمك الكامل">
                </div>
                
                <!-- Phone -->
                <div>
                    <label for="complaint_phone" class="block text-xs md:text-sm font-semibold text-gray-900 mb-2">
                        رقم الهاتف *
                    </label>
                    <input type="tel" 
                           id="complaint_phone" 
                           name="phone" 
                           required
                           class="w-full px-3 md:px-4 py-2.5 md:py-3 text-sm md:text-base border border-gray-300 rounded-lg md:rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all ltr-input"
                           placeholder="05xxxxxxxx"
                           inputmode="numeric"
                           dir="ltr"
                           maxlength="12"
                           pattern="[0-9]*">
                    <p class="mt-1 text-xs md:text-sm text-gray-500">أدخل رقم هاتفك السعودي</p>
                </div>
                
                <!-- Email (Optional) -->
                <div>
                    <label for="complaint_email" class="block text-xs md:text-sm font-semibold text-gray-900 mb-2">
                ...
                <!-- Complaint Type -->
                <div>
                    <label for="complaint_type" class="block text-xs md:text-sm font-semibold text-gray-900 mb-2">
                        نوع الشكوى *
                    </label>
                ...
                <!-- Complaint Details -->
                <div>
                    <label for="complaint_details" class="block text-xs md:text-sm font-semibold text-gray-900 mb-2">
                        تفاصيل الشكوى *
                    </label>
                    <textarea id="complaint_details" 
                              ...
                              required
                              rows="4"
                              class="w-full px-3 md:px-4 py-2.5 md:py-3 text-sm md:text-base border border-gray-300 rounded-lg md:rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all resize-none"
                              placeholder="يرجى وصف مشكلتك بالتفصيل..."></textarea>
                    <p class="mt-1 text-xs md:text-sm text-gray-500">كلما كانت التفاصيل أكثر، سيساعدنا ذلك في حل مشكلتك بشكل أسرع</p>
                </div>
                
                <!-- Submit Button -->
                <div class="pt-2 md:pt-4">
                    <button type="submit" 
                            class="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold py-3 md:py-4 px-4 md:px-6 text-sm md:text-base rounded-lg md:rounded-xl shadow-lg shadow-green-500/30 hover:shadow-green-500/40 transition-all duration-300 transform hover:scale-[1.02] flex items-center justify-center gap-2 md:gap-3">
