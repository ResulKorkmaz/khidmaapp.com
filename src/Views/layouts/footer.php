...
<!-- Complaint Modal -->
<div id="complaintModal" class="fixed inset-0 z-[9999] hidden items-center justify-center p-4 transition-opacity duration-300" style="background: rgba(0, 0, 0, 0.7); backdrop-filter: blur(8px);">
    <div class="relative w-full max-w-2xl max-h-[85vh] overflow-y-auto bg-white rounded-2xl md:rounded-3xl shadow-2xl transform transition-all duration-300 scale-95 opacity-0" id="complaintModalContent">
        <!-- Modal Header -->
        <div class="sticky top-0 bg-gradient-to-r from-red-600 to-red-700 text-white p-4 md:p-6 rounded-t-2xl md:rounded-t-3xl flex items-center justify-between z-10 shadow-lg">
            ...
            <button onclick="closeComplaintModal()" class="w-9 h-9 md:w-10 md:h-10 bg-white/20 hover:bg-white/30 rounded-xl flex items-center justify-center transition-colors flex-shrink-0">
                <svg class="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div class="p-4 md:p-6 lg:p-8">
            <!-- Info Box -->
            <div class="mb-4 md:mb-6 p-3 md:p-4 bg-blue-50 rounded-xl border border-blue-200">
            ...
            <form id="complaintForm" class="space-y-4 md:space-y-5">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           name="name" 
                           required
                           class="w-full px-3 md:px-4 py-2.5 md:py-3 text-sm md:text-base border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all"
                ...
                <div>
                    ...
                    <input type="tel" 
                           ...
                           name="phone" 
                           required
                           class="w-full px-3 md:px-4 py-2.5 md:py-3 text-sm md:text-base border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all ltr-input"
                ...
                <div>
                    ...
                    <textarea id="complaint_details" 
                              ...
                              required
                              rows="4"
                              class="w-full px-3 md:px-4 py-2.5 md:py-3 text-sm md:text-base border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all resize-none"
                ...
                <div class="pt-2 md:pt-4">
                    <button type="submit" 
                            class="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold py-3 md:py-4 px-4 md:px-6 rounded-xl shadow-lg shadow-green-500/30 hover:shadow-green-500/40 transition-all duration-300 transform hover:scale-[1.02] flex items-center justify-center gap-2 md:gap-3 text-sm md:text-base">
