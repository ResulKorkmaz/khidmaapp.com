                ...
                <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="text-2xl font-bold text-blue-900"><?= $purchase['lead_count'] ?></div>
                        </div>
                        <div>
                            <div class="text-sm text-blue-600 mb-1">المبلغ المدفوع</div>
                            <div class="text-2xl font-bold text-blue-900"><?= number_format($purchase['price_paid'], 2) ?> ريال</div>
                        </div>
                    </div>
                </div>
...
// Layout'u yükle
$pageTitle = $pageData['pageTitle'] ?? 'عملية شراء ناجحة';
