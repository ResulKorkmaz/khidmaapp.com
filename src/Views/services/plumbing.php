        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div class="text-right text-white">
                ...
                <h1 class="text-4xl md:text-6xl font-black mb-6 leading-tight">
                    لديك تسريب مياه أو
                    <span class="block mt-2 text-blue-100">مشكلة سباكة طارئة؟</span>
                </h1>
                ...
                <ul class="space-y-3 mb-10">
                    ...
                    <li class="flex items-center gap-3">
                        <div class="w-6 h-6 bg-white rounded-full flex items-center justify-center text-[#3B9DD9] font-bold text-xs">✓</div>
                        <span class="font-bold">ضمان على الإصلاح وقطع الغيار (من مقدم الخدمة)</span>
                    </li>
                </ul>
                ...
                <div class="bg-white rounded-3xl p-8 shadow-2xl border-4 border-white/20">
                    ...
                    <div class="space-y-6 relative">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 text-lg">اطلب الخدمة</h4>
                                <p class="text-gray-600 text-sm">اختر نوع المشكلة وسجل طلبك.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 text-sm">احصل على عروض من سباكين قريبين منك.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 text-lg">تنفيذ وإصلاح</h4>
                                <p class="text-gray-600 text-sm">يقوم الفني بالإصلاح مع الضمان.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="py-20 bg-gray-50">
    <div class="container-custom">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <p class="text-xl text-gray-600">نربطك بمتخصصين في جميع مشاكل المياه والصرف الصحي</p>
        </div>

        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php
            $services = [
                ['title' => 'كشف تسربات المياه', 'icon' => '💧', 'desc' => 'متخصصون يستخدمون أجهزة الموجات الصوتية والحرارية لكشف التسربات بدون تكسير.'],
                ['title' => 'تسليك مجاري', 'icon' => '🛁', 'desc' => 'فنيون يمتلكون مكائن الضغط والسبرينغ لفتح انسداد المجاري والبالوعات.'],
                ['title' => 'تأسيس سباكة', 'icon' => '🏗️', 'desc' => 'مقاولون لتأسيس شبكات التغذية والصرف للمباني الجديدة والحمامات والمطابخ.'],
                ['title' => 'تركيب أدوات صحية', 'icon' => '🚽', 'desc' => 'سباكون لتركيب الكراسي، المغاسل، الشاورات، الخلاطات، والإكسسوارات.'],
                ['title' => 'صيانة مضخات', 'icon' => '⚙️', 'desc' => 'خبراء في تركيب وصيانة مضخات المياه والدينامو لتقوية ضغط المياه.'],
                ['title' => 'سخانات وفلاتر', 'icon' => '🔥', 'desc' => 'فنيون لتركيب وصيانة السخانات المركزية والعادية وفلاتر تنقية المياه.']
            ];
...
<section class="py-20 bg-white border-t border-gray-100">
    <div class="container-custom">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <p class="text-xl text-gray-600">نتحقق من هوية وكفاءة جميع مقدمي الخدمة</p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="text-center p-6">
                ...
                <p class="text-gray-600">نتعامل فقط مع السباكين ذوي الخبرة والسمعة الطيبة لضمان جودة العمل.</p>
            </div>
            <div class="text-center p-6">
                <div class="w-20 h-20 bg-[#3B9DD9]/10 rounded-full flex items-center justify-center text-4xl mx-auto mb-6">⏱️</div>
                <h3 class="text-xl font-black text-gray-900 mb-3">استجابة سريعة</h3>
                <p class="text-gray-600">نوصلك بأقرب سباك لموقعك لتقليل وقت الانتظار وحل المشكلة بسرعة.</p>
            </div>
            <div class="text-center p-6">
                <div class="w-20 h-20 bg-[#3B9DD9]/10 rounded-full flex items-center justify-center text-4xl mx-auto mb-6">🛡️</div>
                <h3 class="text-xl font-black text-gray-900 mb-3">ضمان الخدمة</h3>
                <p class="text-gray-600">نتابع معك حتى التأكد من إتمام العمل وإصلاح العطل بشكل كامل.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div class="text-white">
                ...
                <div class="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
                    ...
                    <p class="text-blue-50">قد يكون لديك تسريب خفي. اطلب خدمة "كشف تسربات" لفحص الشبكة وتوفير المال.</p>
                </div>
            </div>
