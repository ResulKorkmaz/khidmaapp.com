...
$serviceDescription = 'منصة خدمة تربطك بأفضل فنيين السباكة المعتمدين في منطقتك. احصل على عروض أسعار من محترفين موثوقين.';
$serviceMetaDescription = 'ابحث عن أفضل سباك محترف في السعودية | نربطك بمحترفين معتمدين | سباكة منزلية وفلل | عروض أسعار تنافسية | موثوقية وضمان';
$serviceKeywords = 'ترميم, سباك محترف, طلب مقاول, سباكة منزلية, تأسيس سباكة, سباكين, منصة خدمة';
$cities = ['الرياض', 'جدة', 'مكة المكرمة', 'المدينة المنورة', 'الدمام', 'الخبر', 'تبوك', 'أبها'];
$pageTitle = 'اطلب أفضل سباك محترف في السعودية | خيارات موثوقة | KhidmaApp';
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div class="text-right text-white">
                ...
                <p class="text-lg md:text-xl text-green-50 mb-8 leading-relaxed font-medium max-w-2xl">
                    نحن نربطك بأفضل شركات وفنيين السباكة في منطقتك. سجل طلبك الآن وسيقوم نخبة من المحترفين المعتمدين بالتواصل معك لتقديم عروضهم.
                </p>
...
<section class="py-20 bg-gray-50">
    <div class="container-custom">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php
            $services = [
                ['title' => 'ترميم شامل للمنازل', 'icon' => '🏠', 'desc' => 'نربطك بمقاولين متخصصين في إصلاح وصيانة جميع أعطال السباكة المنزلية.'],
                ['title' => 'كشف تسربات', 'icon' => '🏢', 'desc' => 'شركات متخصصة في كشف تسربات المياه بأحدث الأجهزة الإلكترونية.'],
                ['title' => 'تركيب أدوات صحية', 'icon' => '🏛️', 'desc' => 'خبراء في تركيب المغاسل والخلاطات والمراحيض والإكسسوارات بأحدث المواد.'],
                ['title' => 'تسليك مجاري', 'icon' => '🔨', 'desc' => 'فنيون متخصصون في حل مشاكل انسداد الصرف والمجاري بأحدث المعدات.'],
                ['title' => 'صيانة مسابح', 'icon' => '💧', 'desc' => 'متخصصون في صيانة وفحص فلاتر ومضخات المسابح المنزلية.'],
                ['title' => 'تمديد شبكات', 'icon' => '📐', 'desc' => 'مقاولون معتمدون لتأسيس وتمديد شبكات المياه والصرف للمباني الجديدة.']
            ];
    ...
    <div class="container-custom">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-2xl">
                ...
                render_service_request_form('renovation-request-form', 'plumbing', [
