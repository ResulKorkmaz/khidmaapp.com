<?php
/**
 * Service Page: Air Conditioning (تكييف) - MODERN PROFESSIONAL DESIGN
...
$serviceColor = 'sky'; // Brand color for this service
$serviceIcon = '❄️';
$serviceDescription = 'خدمات تكييف شاملة في السعودية - تكييف منازل ومكاتب بأعلى جودة';
$serviceMetaDescription = 'خدمات تكييف احترافية في السعودية | تكييف منازل | تكييف مكاتب | تكييف شقق | شركة تكييف في الرياض جدة الدمام';
$serviceKeywords = 'تكييف, تكييف منازل, تكييف شقق, تكييف مكاتب, شركة تكييف, تكييف في الرياض, تكييف في جدة';
$cities = ['الرياض', 'جدة', 'مكة المكرمة', 'المدينة المنورة', 'الدمام', 'الخبر', 'تبوك', 'أبها'];
$pageTitle = 'خدمات تكييف احترافية في السعودية | شركة تكييف محترفة | KhidmaApp';
$breadcrumb = [
    ['name' => 'الرئيسية', 'url' => '/'],
...
<!-- MODERN HERO SECTION -->
<section class="relative min-h-screen flex items-center justify-center overflow-hidden" style="background: linear-gradient(135deg, #0284c7 0%, #0ea5e9 50%, #075985 100%);">
    <!-- Animated Background -->
    <div class="absolute inset-0">
        <div class="absolute top-20 right-20 w-72 h-72 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob" style="background: #38bdf8;"></div>
        <div class="absolute top-40 left-20 w-72 h-72 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000" style="background: #0ea5e9;"></div>
        <div class="absolute bottom-20 left-1/2 w-72 h-72 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000" style="background: #0284c7;"></div>
    </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div class="text-white">
                ...
                <h1 class="text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-tight">
                    ...
                    <span class="block bg-gradient-to-r from-white via-sky-100 to-white bg-clip-text text-transparent">
                        تكييف احترافية
                    </span>
                </h1>
                
                <!-- Description -->
                <p class="text-xl md:text-2xl text-sky-50 mb-8 leading-relaxed font-semibold">
                    تكييف شامل للمنازل والمكاتب والشقق مع ضمان الجودة والنظافة التامة في جميع أنحاء المملكة
                </p>
                
                <!-- CTA Buttons -->
                <div class="flex flex-wrap gap-4 mb-12">
                    <a href="#request-service" class="group relative inline-flex items-center gap-3 bg-white text-sky-700 font-bold text-lg px-8 py-4 rounded-2xl shadow-2xl hover:shadow-white/30 transition-all hover:scale-105 overflow-hidden">
                        <span class="absolute inset-0 bg-gradient-to-r from-sky-400 to-green-400 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                        ...
                        <span class="relative z-10 group-hover:text-white transition-colors">اطلب خدمة التكييف الآن</span>
                    </a>
                ...
                <div class="grid grid-cols-3 gap-6 bg-white/10 backdrop-blur-md rounded-3xl p-6 border border-white/20">
                    <div class="text-center">
                        ...
                        <div class="text-sky-100 text-sm font-semibold">عميل سعيد</div>
                    </div>
                    <div class="text-center border-r border-l border-white/20">
                        ...
                        <div class="text-sky-100 text-sm font-semibold">التقييم</div>
                    </div>
                    <div class="text-center">
                        <div class="text-4xl font-black mb-1">100%</div>
                        <div class="text-sky-100 text-sm font-semibold">رضا العملاء</div>
                    </div>
                </div>
            </div>
            ...
            <div class="hidden lg:block">
                <div class="relative">
                    ...
                    <div class="absolute -bottom-10 -left-10 w-72 h-72 bg-sky-400/30 rounded-full blur-3xl"></div>
                    ...
                    <div class="relative bg-white/10 backdrop-blur-xl rounded-3xl p-8 border-2 border-white/30 shadow-2xl transform hover:scale-105 transition-transform duration-500">
                        <div class="text-9xl text-center mb-4 filter drop-shadow-2xl">❄️</div>
                        <div class="text-center text-white">
                            <h3 class="text-2xl font-bold mb-2">نظافة مثالية مضمونة</h3>
                            <p class="text-sky-100">فريق محترف وأدوات حديثة</p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="py-24 bg-white">
    <div class="container-custom">
        ...
        <div class="text-center max-w-3xl mx-auto mb-16">
            <span class="inline-block bg-sky-100 text-sky-700 font-bold px-6 py-2 rounded-full mb-4">خدماتنا الشاملة</span>
            <h2 class="text-4xl md:text-5xl font-black text-gray-900 mb-4">ماذا نقدم لك؟</h2>
            <p class="text-xl text-gray-600">حلول تكييف متكاملة لجميع احتياجاتك</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php
            $services = [
                ['title' => 'تكييف منازل', 'icon' => '🏠', 'desc' => 'تكييف شامل للمنازل والفلل بجميع المرافق بأعلى معايير النظافة', 'color' => 'sky'],
                ['title' => 'تكييف شقق', 'icon' => '🏢', 'desc' => 'تكييف احترافي للشقق السكنية قبل وبعد الانتقال', 'color' => 'green'],
                ['title' => 'تكييف مكاتب', 'icon' => '🏪', 'desc' => 'خدمات تكييف دورية للمكاتب والشركات مع عقود صيانة', 'color' => 'teal'],
                ['title' => 'تكييف كنب وسجاد', 'icon' => '🛋️', 'desc' => 'تكييف عميق بالبخار للكنب والسجاد والموكيت', 'color' => 'cyan'],
                ['title' => 'تكييف مطابخ', 'icon' => '🍳', 'desc' => 'تكييف المطابخ وإزالة الدهون المستعصية بأحدث المواد', 'color' => 'lime'],
                ['title' => 'تلميع وجلي', 'icon' => '❄️', 'desc' => 'تلميع الأرضيات والرخام والسيراميك بلمعان دائم', 'color' => 'yellow']
            ];
...
<section class="py-24 bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="container-custom">
        <!-- Section Header -->
        <div class="text-center max-w-3xl mx-auto mb-16">
            <span class="inline-block bg-sky-100 text-sky-700 font-bold px-6 py-2 rounded-full mb-4">نغطي جميع المدن</span>
            <h2 class="text-4xl md:text-5xl font-black text-gray-900 mb-4">خدمات التكييف في مدن السعودية</h2>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <?php foreach ($cities as $index => $city): ?>
                <div class="group relative bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-2 border-transparent hover:border-sky-400 cursor-pointer overflow-hidden">
                    <!-- Background Gradient -->
                    <div class="absolute inset-0 bg-gradient-to-br from-sky-400/0 to-sky-600/0 group-hover:from-sky-400/10 group-hover:to-sky-600/5 transition-all duration-500"></div>
                    
                    <!-- Content -->
                    <div class="relative z-10 text-center">
                        <div class="text-4xl mb-3 group-hover:scale-110 transition-transform duration-500">📍</div>
                        <h3 class="font-black text-gray-900 text-lg mb-1 group-hover:text-sky-600 transition-colors">تكييف في <?= $city ?></h3>
                        <p class="text-sm text-gray-500 group-hover:text-sky-600 transition-colors">خدمة فورية</p>
                    </div>
                    
                    <!-- Decorative corner -->
                    <div class="absolute top-0 right-0 w-16 h-16 bg-sky-400/20 rounded-bl-full transform translate-x-8 -translate-y-8 group-hover:translate-x-0 group-hover:translate-y-0 transition-transform duration-500"></div>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
...
<!-- CTA FORM SECTION -->
<section id="request-service" class="py-24 relative overflow-hidden" style="background: linear-gradient(135deg, #0284c7 0%, #0ea5e9 50%, #075985 100%);">
    <!-- Background Pattern -->
    ...
    <div class="container-custom relative z-10">
        ...
        <div class="text-center max-w-3xl mx-auto mb-12">
            ...
            <p class="text-xl text-sky-100">املأ النموذج وسنتصل بك خلال دقائق</p>
        </div>
        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
                ...
                render_service_request_form('service-ac-form', 'service', [
                    'button_text' => 'اطلب خدمة التكييف الآن',
                    'preselected_service' => 'ac',
                    'form_origin' => 'service_page_ac'
                ]);
                ?>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-12">
            <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 text-center border border-white/20">
                ...
                <p class="text-sky-100 text-sm">نحمي بياناتك بأعلى معايير الأمان</p>
            </div>
            <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 text-center border border-white/20">
                <div class="text-3xl mb-2">⚡</div>
                <h4 class="font-bold text-white mb-1">رد فوري</h4>
                <p class="text-sky-100 text-sm">نتصل بك خلال 5 دقائق</p>
            </div>
            <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 text-center border border-white/20">
                <div class="text-3xl mb-2">💯</div>
                <h4 class="font-bold text-white mb-1">ضمان الجودة</h4>
                <p class="text-sky-100 text-sm">نضمن رضاك 100%</p>
            </div>
        </div>
    </div>
</section>
