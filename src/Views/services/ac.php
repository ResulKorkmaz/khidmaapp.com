...
$serviceDescription = 'منصة خدمة تربطك بأفضل فنيين التكييف المعتمدين في منطقتك. احصل على عروض أسعار من محترفين موثوقين.';
$serviceMetaDescription = 'ابحث عن أفضل فني تكييف في السعودية | نربطك بمحترفين معتمدين | صيانة مكيفات وفلل | عروض أسعار تنافسية | موثوقية وضمان';
$serviceKeywords = 'ترميم, فني تكييف, طلب مقاول, صيانة مكيفات, غسيل مكيفات, مهندسين تكييف, منصة خدمة';
$cities = ['الرياض', 'جدة', 'مكة المكرمة', 'المدينة المنورة', 'الدمام', 'الخبر', 'تبوك', 'أبها'];
$pageTitle = 'اطلب أفضل فني تكييف في السعودية | خيارات موثوقة | KhidmaApp';
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div class="text-right text-white">
                ...
                <p class="text-lg md:text-xl text-green-50 mb-8 leading-relaxed font-medium max-w-2xl">
                    نحن نربطك بأفضل شركات وفنيين التكييف في منطقتك. سجل طلبك الآن وسيقوم نخبة من المحترفين المعتمدين بالتواصل معك لتقديم عروضهم.
                </p>
...
<section class="py-20 bg-gray-50">
    <div class="container-custom">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php
            $services = [
                ['title' => 'ترميم شامل للمنازل', 'icon' => '🏠', 'desc' => 'نربطك بمقاولين متخصصين في صيانة وإصلاح جميع أعطال المكيفات بأنواعها.'],
                ['title' => 'تركيب مكيفات', 'icon' => '🏢', 'desc' => 'شركات متخصصة في غسيل وتنظيف المكيفات في الموقع مع التعقيم.'],
                ['title' => 'تعبئة فريون', 'icon' => '🏛️', 'desc' => 'خبراء في فك وتركيب ونقل المكيفات الاسبليت والشباك بأحدث المواد.'],
                ['title' => 'مكيفات سبليت', 'icon' => '🔨', 'desc' => 'فنيون متخصصون في فحص مستوى الفريون وتعبئة الغاز الأصلي.'],
                ['title' => 'مكيفات مركزية', 'icon' => '💧', 'desc' => 'متخصصون في صيانة وتركيب مكيفات الاسبليت والمركزي.'],
                ['title' => 'عقود صيانة', 'icon' => '📐', 'desc' => 'مقاولون معتمدون لعقود صيانة دورية للمساجد والشركات والمنازل.']
            ];
    ...
    <div class="container-custom">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-2xl">
                ...
                render_service_request_form('renovation-request-form', 'ac', [
