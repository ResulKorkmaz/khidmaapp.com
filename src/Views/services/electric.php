...
$serviceDescription = 'منصة خدمة تربطك بأفضل فنيين الكهرباء المعتمدين في منطقتك. احصل على عروض أسعار من محترفين موثوقين.';
$serviceMetaDescription = 'ابحث عن أفضل كهربائي منازل في السعودية | نربطك بمحترفين معتمدين | كهرباء منازل وفلل | عروض أسعار تنافسية | موثوقية وضمان';
$serviceKeywords = 'ترميم, كهربائي منازل, طلب مقاول, كهرباء منازل, تأسيس كهرباء, كهربائيين, منصة خدمة';
$cities = ['الرياض', 'جدة', 'مكة المكرمة', 'المدينة المنورة', 'الدمام', 'الخبر', 'تبوك', 'أبها'];
$pageTitle = 'اطلب أفضل كهربائي منازل في السعودية | خيارات موثوقة | KhidmaApp';
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div class="text-right text-white">
                ...
                <p class="text-lg md:text-xl text-green-50 mb-8 leading-relaxed font-medium max-w-2xl">
                    نحن نربطك بأفضل شركات وفنيين الكهرباء في منطقتك. سجل طلبك الآن وسيقوم نخبة من المحترفين المعتمدين بالتواصل معك لتقديم عروضهم.
                </p>
...
<section class="py-20 bg-gray-50">
    <div class="container-custom">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php
            $services = [
                ['title' => 'ترميم شامل للمنازل', 'icon' => '🏠', 'desc' => 'نربطك بمقاولين متخصصين في صيانة وإصلاح جميع الأعطال الكهربائية المنزلية.'],
                ['title' => 'إصلاح أعطال', 'icon' => '🏢', 'desc' => 'شركات متخصصة في تشخيص وإصلاح الانقطاعات والماس الكهربائي.'],
                ['title' => 'تركيب إضاءة', 'icon' => '🏛️', 'desc' => 'خبراء في تركيب الثريات والسبوت لايت والإضاءة المخفية بأحدث المواد.'],
                ['title' => 'تمديد كابلات', 'icon' => '🔨', 'desc' => 'فنيون متخصصون في تأسيس وتمديد الكابلات والأسلاك للمباني الجديدة.'],
                ['title' => 'لوحات توزيع', 'icon' => '💧', 'desc' => 'متخصصون في صيانة وتركيب القواطع ولوحات التوزيع الرئيسية.'],
                ['title' => 'أنظمة ذكية', 'icon' => '📐', 'desc' => 'مقاولون معتمدون لتركيب أنظمة المنازل الذكية وكاميرات المراقبة.']
            ];
    ...
    <div class="container-custom">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-2xl">
                ...
                render_service_request_form('renovation-request-form', 'electric', [
