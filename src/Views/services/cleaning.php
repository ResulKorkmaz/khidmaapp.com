...
$serviceDescription = 'منصة خدمة تربطك بأفضل شركات التنظيف المعتمدين في منطقتك. احصل على عروض أسعار من محترفين موثوقين.';
$serviceMetaDescription = 'ابحث عن أفضل شركة تنظيف في السعودية | نربطك بمحترفين معتمدين | تنظيف منازل وفلل | عروض أسعار تنافسية | موثوقية وضمان';
$serviceKeywords = 'ترميم, شركة تنظيف, طلب مقاول, تنظيف منازل, تنظيف شقق, عمال نظافة, منصة خدمة';
$cities = ['الرياض', 'جدة', 'مكة المكرمة', 'المدينة المنورة', 'الدمام', 'الخبر', 'تبوك', 'أبها'];
$pageTitle = 'اطلب أفضل شركة تنظيف في السعودية | خيارات موثوقة | KhidmaApp';
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div class="text-right text-white">
                ...
                <p class="text-lg md:text-xl text-green-50 mb-8 leading-relaxed font-medium max-w-2xl">
                    نحن نربطك بأفضل شركات وشركات التنظيف في منطقتك. سجل طلبك الآن وسيقوم نخبة من المحترفين المعتمدين بالتواصل معك لتقديم عروضهم.
                </p>
...
<section class="py-20 bg-gray-50">
    <div class="container-custom">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php
            $services = [
                ['title' => 'ترميم شامل للمنازل', 'icon' => '🏠', 'desc' => 'نربطك بمقاولين متخصصين في تنظيف شامل وعميق للمنازل والشقق المفروشة.'],
                ['title' => 'تنظيف فلل', 'icon' => '🏢', 'desc' => 'شركات متخصصة في تنظيف الفلل والقصور الجديدة وبعد التشطيب.'],
                ['title' => 'تنظيف كنب', 'icon' => '🏛️', 'desc' => 'خبراء في غسيل الكنب والسجاد والموكيت بالبخار في الموقع بأحدث المواد.'],
                ['title' => 'تنظيف خزانات', 'icon' => '🔨', 'desc' => 'فنيون متخصصون في تنظيف وتعقيم خزانات المياه الأرضية والعلوية.'],
                ['title' => 'مكافحة حشرات', 'icon' => '💧', 'desc' => 'متخصصون في رش المبيدات ومكافحة جميع أنواع الحشرات.'],
                ['title' => 'جلي بلاط', 'icon' => '📐', 'desc' => 'مقاولون معتمدون لجلي وتلميع الرخام والبلاط والسيراميك.']
            ];
    ...
    <div class="container-custom">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-2xl">
                ...
                render_service_request_form('renovation-request-form', 'cleaning', [
